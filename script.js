...
const runtimeConfig = window.ATHENA_CONFIG ?? {};
...
if (missingConfigKeys.length) {
  throw new Error(
    `Missing required config values: ${missingConfigKeys.join(", ")}. Create/update local config.js before running the app.`,
  );
}
...
const YT_API_KEY = runtimeConfig.YT_API_KEY;
